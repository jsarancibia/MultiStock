...
--
-- Este script es seguro de ejecutar incluso si faltan migraciones previas.

-- ====================================================
-- 1.1) Renombrar 'staff' → 'employee' (solo si la tabla existe)
-- ====================================================
do $$
begin
...
-- ====================================================
-- 1.2) Reemplazar constraint con roles futuro-proof (solo si la tabla existe)
-- ====================================================
do $$
begin
  if exists (select 1 from information_schema.tables where table_schema = 'public' and table_name = 'business_users') then
...
--      (Creada con SQL dinámico por si faltan migraciones previas)
-- ====================================================
do $$
begin
  if exists (select 1 from information_schema.tables where table_schema = 'public' and table_name = 'businesses') then
    execute format('
      ...
      $f$;
    ');
    execute format('grant execute on function public.get_business_role(uuid) to authenticated;');
  end if;
end $$;
...
-- ====================================================
-- 1.10) RLS: Audit logs — employee no puede SELECT
-- ====================================================
do $$
begin
