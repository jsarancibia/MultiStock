-- Fase 7 arquitectura3: venta atomica con descuento de stock y movimientos sale
...
begin
  ...
  -- Pre-validamos y bloqueamos productos para evitar inconsistencias concurrentes.
...
grant execute on function public.create_sale_with_items(uuid, uuid, text, jsonb) to authenticated;
